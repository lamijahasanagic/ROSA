 ...
 *
 * Comment:
 * 	All system ticks will be measured in rosaTicks. By default 
 *  one rosaTicks is equivalent to 1 ms. 
 *
 **********************************************************/

typedef uint32_t rosaTicks;
...
typedef struct tcb_record_t {
	...
	uint32_t originalpriority; // The original priority of the task
	rosaTicks wakeuptime;	   // The time in system clock ticks when the task should become ready
