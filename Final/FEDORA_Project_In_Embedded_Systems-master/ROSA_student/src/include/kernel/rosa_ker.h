...
extern void ROSA_TaskCreate(tcb * tcbTaskHandle, char tcbName[NAMESIZE], void *tcbFunction, int * tcbStack, int tcbStackSize, unsigned int Priority);

//Install a new task TCB into ROSA
extern void ROSA_tcbInstall(tcb *task);
extern void ROSA_tcbInstallTask(tcb *taskHandle);
...
extern void ROSA_tcbInstallTaskIntoWaiting(tcb * tcbTaskHandle);
#endif /* _ROSA_KER_H_ */
